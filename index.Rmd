...
# my_palette <- colorRampPalette(brewer.pal(8, "Dark2")[c(2,4,6,8,1)])
# my_colors <- my_palette(5)

#my_palette <- colorRampPalette(c("#000033", "#9933CC", "#FF00FF", "#FF3333", "#FFFF00"))(100)
...
### Ceptrogram
```{r}
elephant_ceptrogram <- readRDS(file = "data/elephant_ceptrogram (Ceptrogram).RDS")
